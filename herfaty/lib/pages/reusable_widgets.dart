...
focusedErrorBorder:  OutlineInputBorder(
    ...
    if (value == null || value.isEmpty) {
     ...
     if (!RegExp(
                  ...
                  .hasMatch(value)&& !isPasswordType &&text=='البريد الإلكتروني') {
...
TextFormField reusableTextFieldForPhone(String text, IconData icon, bool isPasswordType,
    TextEditingController controller) {
  return TextFormField(
    controller: controller,
    obscureText: isPasswordType,
...
TextFormField reusableTextFieldForName(String text, IconData icon, bool isPasswordType,
    TextEditingController controller) {
  return TextFormField(
    controller: controller,
    obscureText: isPasswordType,
...
TextFormField reusableTextFieldDec(String text, IconData icon, bool isPasswordType,
    TextEditingController controller) {
  return TextFormField(
    controller: controller,
    obscureText: isPasswordType,
