                          ...
                          if (data.isNotEmpty) {
                            ...
                            if (!allZeros) {
                              ...
                              if (fiveHundredPoints) {
                                shopAndRank1
                                    .forEach((k, v) => topShops1.add(k));
                              }

                              if (twoHundredPoints) {
                                shopAndRank2
                                    .forEach((k, v) => topShops2.add(k));
                              }

                              if (hundredPoints) {
                                shopAndRank3
                                    .forEach((k, v) => topShops3.add(k));
                              }

                              if (fiftyPoints) {
                                shopAndRank4
                                    .forEach((k, v) => topShops4.add(k));
                              }
                              if (tenPoints) {
                                shopAndRank5
                                    .forEach((k, v) => topShops5.add(k));
                              }
                            } //end not all zeros
                          } //end data not empty
                          if (data.isEmpty) {
                                ...
                                children: [
                                  ...
                                  if (!fiveHundredPoints)
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          'لم يصل أي متجر إلى هذا الكأس بعد',
                                          style: TextStyle(
                                            fontSize: 18.0,
                                            fontWeight: FontWeight.w600,
                                            fontFamily: "Tajawal",
